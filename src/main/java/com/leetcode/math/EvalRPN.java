...
public class EvalRPN {
  ...
  public int evalRPN(String[] tokens) {
    ...
    for (int i = 0; i < tokens.length; i++) {
      String s = tokens[i];
      if (Operator.Plus.getOps().equals(s)) {
        a = stack.pop();
        b = stack.pop();
        stack.push(a + b);
      } else if (Operator.Minus.getOps().equals(s)) {
        a = stack.pop();
        b = stack.pop();
        stack.push(b - a);
      } else if (Operator.Muliply.getOps().equals(s)) {
        a = stack.pop();
        b = stack.pop();
        stack.push(a * b);
      } else if (Operator.Devide.getOps().equals(s)) {
        a = stack.pop();
        b = stack.pop();
        stack.push(b / a);
      } else {
